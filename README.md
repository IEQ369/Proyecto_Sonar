# Exfiltración de Datos por Ultrasonido - SONAR
...
### Hardware
- Micrófono capaz de capturar frecuencias >18 kHz
- Parlante capaz de emitir frecuencias >18 kHz
- Dispositivo con navegador moderno probados hasta ahora (Chrome, brave)

### Software
- Navegador web con soporte para Web Audio API
...
# http://localhost:8000/archivos (archivos)
```
...
```bash
# Copiar nginx.conf a tu configuración de nginx
# Acceder via HTTPS para permisos móviles
```
